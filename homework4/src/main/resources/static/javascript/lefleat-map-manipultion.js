...
var radiusSelected = localStorage.getItem("radiusValue") === null ? 15000 :  Number.parseInt(localStorage.getItem("radius"))*1000;
...
function getPosition(position="no value"){
    ...
    if(localStorage.getItem("radiusValue")===null)
    {
        ...
        radiusSelected = 15000;
    }

    else
    {
        radiusSelected = localStorage.getItem("radiusValue") * 1000;
    }
