...
function getPosition(position ){
    ...
    var address = document.getElementById("nearest_hospitals").getAttribute("href");
    document.getElementById("nearest_hospitals").setAttribute("href",address + `?latitude=${localStorage.getItem("latitude")}&longitude=${localStorage.getItem("longitude")}&radius=${localStorage.getItem("radius")}`);
